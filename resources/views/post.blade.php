<x-layout>
    ...
    {{-- <article class="py-8 max-w-screen-md">
        <h2 class="mb-1 text-3xl tracking-tight font-semibold text-gray-900">{{ $post['title'] }}</h2>
            ...
            <header class="mb-4 lg:mb-6 not-format">
                ...
                <address class="flex items-center my-6 not-italic">
                    <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                        ...
                        <div>
                            <a href="/posts?author={{ $post->author->username }}" rel="author" class="text-xl font-bold text-gray-800 dark:text-white hover:underline">{{ $post->author->name }}</a>
